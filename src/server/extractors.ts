import { cleanIpAddress } from '../shared/ip';
import type { CloudflareCfData, GeoLocationInfo } from '../shared/types';
...
export function extractCloudflareGeo(cf?: CloudflareCfData | null): GeoLocationInfo | undefined {
  ...
  return {
    ...
    longitude: lon !== undefined && Number.isFinite(lon) ? lon : undefined,
